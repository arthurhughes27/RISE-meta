...
ggsave(
  filename = "transcriptomic_samples_influenzain_day1.pdf",
...
ggsave(
  filename = "antibody_samples_influenzain_day1.pdf",
  path = descriptive_figures_folder,
  plot = p2,
  width = 30,
  height = 13,
...
ggsave(
  filename = "sex_distribution_influenzain_day1.pdf",
  path = descriptive_figures_folder,
  plot = p3,
  width = 30,
  height = 13,
...
ggsave(
  filename = "age_distribution_influenzain_day1.pdf",
  plot = p4,
  path = descriptive_figures_folder,
  width = 30,
  height = 13,
...
ggsave(
  filename = "agecat_distribution_influenzain_day1.pdf",
  path = descriptive_figures_folder,
  plot = p5,
  width = 30,
  height = 13,
